...
plot3d(GPA$consensus)
makeGif('ProcrustesCombined', species, surface)
...
makeGif('deform3DCombined', species, surface)

transformConfigurations(macaque, human)

```

Deviation along Principle Components
```{r}
for(i in 1:4) {
...
# ANOVA
if(species == 'combined') {
  multivariateAnalysis(GPA, species=TRUE)
} else { multivariateAnalysis(GPA)}
